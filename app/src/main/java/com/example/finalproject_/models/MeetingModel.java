...
public class MeetingModel {
    ...
    public MeetingModel(String meeting_name, String date, String time, String location, String caregiver_details, Boolean took_place, String receipt, String submitted, String returned) {
